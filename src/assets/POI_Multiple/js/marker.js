function Marker(poiData) {
    ...
    */
    ...
    this.markerDrawable_idle = new AR.ImageDrawable(World.markerDrawables[poiData.category]["idle"], 2.5, {
        zOrder: 0,
        opacity: 1.0,
        /*
    ...
    this.markerDrawable_selected = new AR.ImageDrawable(World.markerDrawables[poiData.category]["selected"], 2.5, {
        zOrder: 0,
        opacity: 0.0,
        onClick: null
    });
